NASUX_PKG_HOMEPAGE=https://gcc.gnu.org/
NASUX_PKG_DESCRIPTION="Libraries coming with GCC (libgcc, libstdc++, etc.)"
NASUX_PKG_LICENSE="GPL-3.0, LGPL-3.0"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION=(12.2.0)
...
NASUX_PKG_SRCURL=(https://ftp.gnu.org/gnu/gcc/gcc-${NASUX_PKG_VERSION}/gcc-${NASUX_PKG_VERSION}.tar.xz
                   https://ftp.gnu.org/gnu/binutils/binutils-${NASUX_PKG_VERSION[1]}.tar.xz
                   https://ftp.gnu.org/gnu/mpfr/mpfr-${NASUX_PKG_VERSION[2]}.tar.xz
                   https://ftp.gnu.org/gnu/mpc/mpc-${NASUX_PKG_VERSION[3]}.tar.gz)
NASUX_PKG_SHA256=(e549cf9cf3594a00e27b6589d4322d70e0720cdd213f39beb4181e06926230ff
...
termux_step_post_get_source() {
	rm -rf .src
	mkdir -p .src
	mv binutils-${NASUX_PKG_VERSION[1]} .src/binutils
	mv mpfr-${NASUX_PKG_VERSION[2]} .src/mpfr
	mv mpc-${NASUX_PKG_VERSION[3]} .src/mpc
}
