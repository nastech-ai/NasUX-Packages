NASUX_PKG_HOMEPAGE=https://github.com/dmpop/tenki
NASUX_PKG_DESCRIPTION="A simple PHP application for logging current weather conditions, notes, and waypoints"
NASUX_PKG_LICENSE="GPL-3.0"
NASUX_PKG_MAINTAINER="@nastech-ai"
_COMMIT=cb07deb9d8c8fc5849f8752f6f0605f72f96fd9b
NASUX_PKG_VERSION=2022.05.26
NASUX_PKG_SRCURL=git+https://github.com/dmpop/tenki
NASUX_PKG_SHA256=7bdea2d3e09709d6562503833c4cd995aa40303a14c75f6a4338dfd40750d2ca
TERMUX_PKG_AUTO_UPDATE=false
TERMUX_PKG_GIT_BRANCH=main
NASUX_PKG_DEPENDS="apache2, php"
