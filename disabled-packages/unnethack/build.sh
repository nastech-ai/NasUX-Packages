...
NASUX_PKG_HOMEPAGE=https://sourceforge.net/apps/trac/unnethack
NASUX_PKG_DESCRIPTION="Dungeon crawling game, fork of NetHack"
NASUX_PKG_LICENSE="custom"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION=5.1.0
NASUX_PKG_SRCURL=https://downloads.sourceforge.net/project/unnethack/unnethack/${NASUX_PKG_VERSION}/unnethack-${NASUX_PKG_VERSION}-20131208.tar.gz
NASUX_PKG_SHA256=d92886a02fd8f5a427d1acf628e12ee03852fdebd3af0e7d0d1279dc41c75762
