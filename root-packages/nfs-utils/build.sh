NASUX_PKG_HOMEPAGE=https://linux-nfs.org/
NASUX_PKG_DESCRIPTION="Linux NFS userland utilities"
NASUX_PKG_LICENSE="GPL-2.0"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="2.9.1"
NASUX_PKG_SRCURL=https://downloads.sourceforge.net/nfs/nfs-utils-${NASUX_PKG_VERSION}.tar.bz2
NASUX_PKG_SHA256=3e9804674f44d18c693f2aedf8c8cc92531edc9f93e6220f70380d3993c500c8
NASUX_PKG_DEPENDS="keyutils, libblkid, libcap, libdevmapper, libevent, libmount, libnl, libsqlite, libtirpc, libuuid, openldap"
