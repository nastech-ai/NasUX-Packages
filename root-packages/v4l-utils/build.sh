NASUX_PKG_HOMEPAGE=https://git.linuxtv.org/v4l-utils.git
NASUX_PKG_DESCRIPTION="Linux utilities to handle media devices"
NASUX_PKG_LICENSE="GPL-2.0, LGPL-2.1"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION=1.24.1
TERMUX_PKG_REVISION=2
NASUX_PKG_SRCURL=https://linuxtv.org/downloads/v4l-utils/v4l-utils-${NASUX_PKG_VERSION}.tar.bz2
NASUX_PKG_SHA256=cbb7fe8a6307f5ce533a05cded70bb93c3ba06395ab9b6d007eb53b75d805f5b
NASUX_PKG_DEPENDS="argp, libc++, libv4l"
