NASUX_PKG_HOMEPAGE="https://invent.kde.org/plasma/breeze-gtk"
NASUX_PKG_DESCRIPTION="Breeze widget theme for GTK 2 and 3"
NASUX_PKG_LICENSE="LGPL-2.0-or-later"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="6.6.5"
NASUX_PKG_SRCURL="https://download.kde.org/stable/plasma/${NASUX_PKG_VERSION}/breeze-gtk-${NASUX_PKG_VERSION}.tar.xz"
NASUX_PKG_SHA256=76caad4ca2e3ce8b02ae1ebe0c068101bb07db51da47f88fa3a40cdce393abf6
