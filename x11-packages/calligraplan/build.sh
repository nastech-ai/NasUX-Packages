NASUX_PKG_HOMEPAGE=https://calligra.org/components/plan/
NASUX_PKG_DESCRIPTION="Visual database applications creator"
NASUX_PKG_LICENSE="GPL-2.0-or-later, LGPL-2.1-or-later"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="4.0.1"
NASUX_PKG_SRCURL="https://download.kde.org/stable/calligraplan/calligraplan-${NASUX_PKG_VERSION}.tar.xz"
NASUX_PKG_SHA256=9267ea174c04466014343927f73757bb3047dab36a74fc8f38b891e8d8833a39
TERMUX_PKG_AUTO_UPDATE=true
TERMUX_PKG_HOSTBUILD=true
NASUX_PKG_DEPENDS="libc++, kdiagram, kf6-kcalendarcore, kf6-karchive, kf6-kcompletion, kf6-kconfig, kf6-kconfigwidgets, kf6-kcoreaddons, kf6-kdbusaddons, kf6-kholidays, kf6-ki18n, kf6-kiconthemes, kf6-kio, kf6-kitemmodels, kf6-kitemviews, kf6-kjobwidgets, kf6-knotifications, kf6-kparts, kf6-kservice, kf6-ktextwidgets, kf6-kwallet, kf6-kwidgetsaddons, kf6-kwindowsystem, kf6-kxmlgui, plasma-activities, qt6-qtbase"
