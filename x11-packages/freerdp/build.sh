NASUX_PKG_HOMEPAGE=https://www.freerdp.com/
NASUX_PKG_DESCRIPTION="A free remote desktop protocol library and clients"
NASUX_PKG_LICENSE="Apache-2.0"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="3.26.0"
NASUX_PKG_SRCURL=https://github.com/FreeRDP/FreeRDP/archive/refs/tags/$NASUX_PKG_VERSION.tar.gz
NASUX_PKG_SHA256=ae3b1c0b8e334ecbc2c784bce266249309fad32a0ef41947ce5c059eb18e2059
TERMUX_PKG_AUTO_UPDATE=true
NASUX_PKG_DEPENDS="libandroid-shmem, libcairo, libicu, libjpeg-turbo, libusb, libwayland, libx11, libxcursor, libxdamage, libxext, libxfixes, libxi, libxinerama, libxkbcommon, libxkbfile, libxrandr, libxrender, libxv, openssl, pulseaudio, zlib"
