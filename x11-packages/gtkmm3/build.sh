...
NASUX_PKG_VERSION="3.24.10"
TERMUX_PKG_REVISION=1
NASUX_PKG_SRCURL=https://download.gnome.org/sources/gtkmm/${NASUX_PKG_VERSION%.*}/gtkmm-${NASUX_PKG_VERSION}.tar.xz
NASUX_PKG_SHA256=7ab7e2266808716e26c39924ace1fb46da86c17ef39d989624c42314b32b5a76
# Prevent updating to incompatible 4.x.x versions
TERMUX_PKG_AUTO_UPDATE=false
NASUX_PKG_DEPENDS="gdk-pixbuf, glib, gtk3, libatkmm-1.6, libc++, libcairomm-1.0, libglibmm-2.4, libpangomm-1.4, libsigc++-2.0"
