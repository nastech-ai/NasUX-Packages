NASUX_PKG_HOMEPAGE='https://apps.kde.org/kdenlive/'
NASUX_PKG_DESCRIPTION='A non-linear video editor for Linux using the MLT video framework'
NASUX_PKG_LICENSE="GPL-2.0"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="26.04.2"
NASUX_PKG_SRCURL=https://download.kde.org/stable/release-service/${NASUX_PKG_VERSION}/src/kdenlive-${NASUX_PKG_VERSION}.tar.xz
NASUX_PKG_SHA256=272dbf81fc4b85d270dedbe38bc57fd37540b812baa3f2b48535031f2c37ab18
NASUX_PKG_DEPENDS="libc++, ffplay, frei0r-plugins, kddockwidgets, kf6-karchive, kf6-kbookmarks, kf6-kcodecs, kf6-kcolorscheme, kf6-kcompletion, kf6-kconfig, kf6-kconfigwidgets, kf6-kcoreaddons, kf6-kdbusaddons, kf6-kfilemetadata, kf6-kguiaddons, kf6-ki18n, kf6-kiconthemes, kf6-kio, kf6-kitemviews, kf6-knewstuff, kf6-knotifications, kf6-knotifyconfig, kf6-ktextwidgets, kf6-kwidgetsaddons, kf6-kxmlgui, kf6-purpose, kf6-qqc2-desktop-style, kf6-solid, mediainfo, mlt, opentimelineio, qt6-qtbase, qt6-qtdeclarative, qt6-qtmultimedia, qt6-qtnetworkauth, qt6-qtsvg, shared-mime-info"
