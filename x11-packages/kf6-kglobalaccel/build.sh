NASUX_PKG_HOMEPAGE='https://invent.kde.org/frameworks/kglobalaccel'
NASUX_PKG_DESCRIPTION='Add support for global workspace shortcuts'
NASUX_PKG_LICENSE="LGPL-2.0, LGPL-3.0"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="6.27.0"
NASUX_PKG_SRCURL="https://download.kde.org/stable/frameworks/${NASUX_PKG_VERSION%.*}/kglobalaccel-${NASUX_PKG_VERSION}.tar.xz"
NASUX_PKG_SHA256=e7ba1601a159ea79f424a4d53647415393f90dbeda1e3216d023eeb5420837d3
