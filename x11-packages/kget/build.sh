NASUX_PKG_HOMEPAGE="https://apps.kde.org/kget/"
NASUX_PKG_DESCRIPTION="Download Manager by KDE"
NASUX_PKG_LICENSE="GPL-2.0-or-later, LGPL-2.0-or-later"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="26.04.2"
NASUX_PKG_SRCURL="https://download.kde.org/stable/release-service/${NASUX_PKG_VERSION}/src/kget-${NASUX_PKG_VERSION}.tar.xz"
NASUX_PKG_SHA256=e4643214ddc3c43eada345eeb33418963c9f880903a0410db2320423521be669
TERMUX_PKG_AUTO_UPDATE=true
NASUX_PKG_DEPENDS="gpgmepp, kf6-kcmutils, kf6-kcolorscheme, kf6-kcompletion, kf6-kconfig, kf6-kconfigwidgets, kf6-kcoreaddons, kf6-kcrash, kf6-kdbusaddons, kf6-ki18n, kf6-kiconthemes, kf6-kio, kf6-kitemviews, kf6-knotifications, kf6-knotifyconfig, kf6-kstatusnotifieritem, kf6-kwallet, kf6-kwidgetsaddons, kf6-kwindowsystem, kf6-kxmlgui, libc++, qgpgme, qt6-qtbase"
