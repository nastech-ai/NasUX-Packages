NASUX_PKG_HOMEPAGE="https://invent.kde.org/network/kio-extras"
NASUX_PKG_DESCRIPTION="Additional components to increase the functionality of KIO"
NASUX_PKG_LICENSE="LGPL-2.0-or-later"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="26.04.2"
NASUX_PKG_SRCURL="https://download.kde.org/stable/release-service/${NASUX_PKG_VERSION}/src/kio-extras-${NASUX_PKG_VERSION}.tar.xz"
NASUX_PKG_SHA256=af4941af624f883891d33701aa0ce4216d6de114db3e4a250099c52d3d42acaa
TERMUX_PKG_AUTO_UPDATE=true
NASUX_PKG_DEPENDS="bash, kf6-karchive, kf6-kcmutils, kf6-kconfig, kf6-kcoreaddons, kf6-kdbusaddons, kf6-kdnssd, kf6-ki18n, kf6-kio, kf6-knotifications, kf6-kservice, kf6-kwidgetsaddons, kf6-syntax-highlighting, kf6-solid, libimobiledevice, libc++, libkexiv2, libproxy, libplist, libssh, libtirpc, libxcursor, perl, plasma-activities, qcoro, qt6-qt5compat, qt6-qtbase, qt6-qtimageformats, qt6-qtsvg, ripgrep-all"
