NASUX_PKG_HOMEPAGE="https://apps.kde.org/konqueror/"
NASUX_PKG_DESCRIPTION="KDE File Manager & Web Browser"
NASUX_PKG_LICENSE="LGPL-2.0-or-later"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="26.04.2"
NASUX_PKG_SRCURL="https://download.kde.org/stable/release-service/${NASUX_PKG_VERSION}/src/konqueror-${NASUX_PKG_VERSION}.tar.xz"
NASUX_PKG_SHA256=aa9a35f81fa1f30aac1d77b9008d074fb041b2a7c12319d1f8c9b194137e57de
TERMUX_PKG_AUTO_UPDATE=true
TERMUX_PKG_HOSTBUILD=true
NASUX_PKG_DEPENDS="kf6-karchive, kf6-kbookmarks, kf6-kcmutils, kf6-kcodecs, kf6-kcolorscheme, kf6-kcompletion, kf6-kconfig, kf6-kconfigwidgets, kf6-kcoreaddons, kf6-kcrash, kf6-kdbusaddons, kf6-kguiaddons, kf6-ki18n, kf6-kiconthemes, kf6-kio, kf6-kitemviews, kf6-kjobwidgets, kf6-kparts, kf6-kservice, kf6-ktextwidgets, kf6-kwallet, kf6-kwidgetsaddons, kf6-kwindowsystem, kf6-kxmlgui, kf6-solid, kf6-sonnet, libc++, plasma-activities, qt6-qtbase, qt6-qtwebengine, zlib"
