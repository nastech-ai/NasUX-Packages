NASUX_PKG_HOMEPAGE=https://www.bunkus.org/videotools/mkvtoolnix/
NASUX_PKG_DESCRIPTION="Set of tools to create, edit and inspect Matroska files"
NASUX_PKG_LICENSE="GPL-2.0"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="99.0"
NASUX_PKG_SRCURL=git+https://codeberg.org/mbunkus/mkvtoolnix
TERMUX_PKG_GIT_BRANCH="release-$NASUX_PKG_VERSION"
TERMUX_PKG_AUTO_UPDATE=true
TERMUX_PKG_UPDATE_VERSION_REGEXP="\d+\.\d+"
NASUX_PKG_DEPENDS="boost, libc++, libebml, libflac, libgmp, libiconv, libmatroska, libogg, libvorbis, qt6-qtbase, zlib"
