NASUX_PKG_HOMEPAGE=https://octave.org
NASUX_PKG_DESCRIPTION="GNU Octave is a high-level language, primarily intended for numerical computations"
NASUX_PKG_LICENSE="GPL-3.0"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="2:10.3.0"
TERMUX_PKG_REVISION=2
NASUX_PKG_SRCURL="https://ftpmirror.gnu.org/octave/octave-${NASUX_PKG_VERSION#*:}.tar.xz"
NASUX_PKG_SHA256=92ae9bf2edcd288bd2df9fd0b4f7aa719b49d3940fceb154c5fdcd846f254da1
NASUX_PKG_DEPENDS="arpack-ng, clang, fftw, fltk, fontconfig, freetype, ghostscript, glpk, glu, graphicsmagick, libandroid-complex-math, libbz2, libc++, libcurl, libhdf5, libiconv, libopenblas, libsndfile, libx11, libxcursor, libxext, libxfixes, libxft, libxinerama, libxrender, make, opengl, openssl, pcre2, portaudio, qhull, qrupdate-ng, qscintilla-qt6, qt6-qt5compat, qt6-qtbase, qt6-qttools, readline, suitesparse, sundials, zlib"
...
termux_step_post_get_source() {
	...
	local ver_x=$(. $NASUX_SCRIPTDIR/packages/octave/build.sh; echo ${NASUX_PKG_VERSION#*:})
	if [ "${ver_e}" != "${ver_x}" ]; then
...
termux_step_pre_configure() {
	...
	LDFLAGS+=" -Wl,-rpath,$TERMUX_PREFIX/lib/octave/$NASUX_PKG_VERSION"
