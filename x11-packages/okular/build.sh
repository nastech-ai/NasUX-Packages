NASUX_PKG_HOMEPAGE="https://apps.kde.org/okular"
NASUX_PKG_DESCRIPTION="Multi-platform document viewer for PDF, comics, EPub, and images"
NASUX_PKG_LICENSE="GPL-2.0-or-later, LGPL-2.0-or-later"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="26.04.2"
NASUX_PKG_SRCURL="https://download.kde.org/stable/release-service/${NASUX_PKG_VERSION}/src/okular-${NASUX_PKG_VERSION}.tar.xz"
NASUX_PKG_SHA256=d51cc5be96f6e491181608b0115af37d20ee15b080b6e42c0c00e29b9e058abe
TERMUX_PKG_AUTO_UPDATE=true
NASUX_PKG_DEPENDS="discount, djvulibre, freetype, kf6-karchive, kf6-kbookmarks, kf6-kcolorscheme, kf6-kcompletion, kf6-kconfig, kf6-kconfigwidgets, kf6-kcoreaddons, kf6-kcrash, kf6-ki18n, kf6-kiconthemes, kf6-kio, kf6-kparts, kf6-ktextwidgets, kf6-kwallet, kf6-kwidgetsaddons, kf6-kwindowsystem, kf6-kxmlgui, kf6-purpose, kf6-threadweaver, libc++, libkexiv2, libspectre, libtiff, phonon-qt6, poppler-qt, qt6-qtbase, qt6-qtdeclarative, qt6-qtspeech, qt6-qtsvg, unrar, zlib"
