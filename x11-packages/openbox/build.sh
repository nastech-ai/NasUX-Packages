NASUX_PKG_HOMEPAGE=http://openbox.org
NASUX_PKG_DESCRIPTION="Highly configurable and lightweight X11 window manager"
NASUX_PKG_LICENSE="GPL-2.0"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION=3.6.1
TERMUX_PKG_REVISION=61
NASUX_PKG_SRCURL=http://openbox.org/dist/openbox/openbox-${NASUX_PKG_VERSION}.tar.gz
NASUX_PKG_SHA256=8b4ac0760018c77c0044fab06a4f0c510ba87eae934d9983b10878483bde7ef7
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="--disable-session-management"
NASUX_PKG_DEPENDS="bash, fontconfig, freetype, gdk-pixbuf, glib, harfbuzz, imlib2, libcairo, libice, librsvg, libsm, libx11, libxcursor, libxext, libxft, libxinerama, libxml2, libxrandr, libxrender, pango, startup-notification"
