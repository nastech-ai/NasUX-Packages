NASUX_PKG_HOMEPAGE=https://github.com/notaz/pcsx_rearmed
NASUX_PKG_DESCRIPTION="Yet another PCSX fork based on the PCSX-Reloaded project"
NASUX_PKG_LICENSE="GPL-2.0"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="26"
NASUX_PKG_SRCURL=git+https://github.com/notaz/pcsx_rearmed
TERMUX_PKG_GIT_BRANCH=r${NASUX_PKG_VERSION}
NASUX_PKG_SHA256=887e9b5ee7b8115d35099c730372b4158fd3e215955a06d68e20928b339646af
TERMUX_PKG_AUTO_UPDATE=true
NASUX_PKG_DEPENDS="libpng, opengl, pulseaudio, sdl, zlib"
TERMUX_PKG_BUILD_DEPENDS="binutils-cross"
NASUX_PKG_BUILD_IN_SRC=true

termux_pkg_auto_update() {
	# Get latest release tag:
	local tag="$(termux_github_api_get_tag "${NASUX_PKG_SRCURL}")"
...
termux_step_post_get_source() {
	# convert CRLF to LF globally while working with this package in nasux
	# https://github.com/nastech-ai/NasUX-Packages/issues/11744
