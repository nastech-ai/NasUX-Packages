NASUX_PKG_HOMEPAGE="https://invent.kde.org/plasma/plasma-integration"
NASUX_PKG_DESCRIPTION="Qt Platform Theme integration plugins for the Plasma workspaces"
NASUX_PKG_LICENSE="LGPL-2.0-or-later"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="6.6.5"
NASUX_PKG_SRCURL="https://download.kde.org/stable/plasma/${NASUX_PKG_VERSION}/plasma-integration-${NASUX_PKG_VERSION}.tar.xz"
NASUX_PKG_SHA256=c28482dc8d3387b9a770fdc999dd13480b14714568395c8d86bd568b0181920a
TERMUX_PKG_AUTO_UPDATE=true
NASUX_PKG_DEPENDS="kf6-kcolorscheme, kf6-kcompletion, kf6-kconfig, kf6-kcoreaddons, kf6-kguiaddons, kf6-ki18n, kf6-kiconthemes, kf6-kio, kf6-kjobwidgets, kf6-kservice, kf6-kstatusnotifieritem, kf6-kwidgetsaddons, kf6-kwindowsystem, kf6-kxmlgui, qqc2-breeze-style, kf6-qqc2-desktop-style, libc++, libwayland, libxcb, libxcursor, qt6-qtbase, qt6-qtdeclarative"
