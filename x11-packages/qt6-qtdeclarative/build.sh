...
NASUX_PKG_DESCRIPTION="Classes for QML and JavaScript languages"
NASUX_PKG_LICENSE="GPL-3.0"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="6.11.1"
NASUX_PKG_SRCURL="https://download.qt.io/official_releases/qt/${NASUX_PKG_VERSION%.*}/${NASUX_PKG_VERSION}/submodules/qtdeclarative-everywhere-src-${NASUX_PKG_VERSION}.tar.xz"
NASUX_PKG_SHA256=52e670f670b0304f534b24f98c47ceb8a41bb710464414ebc9527ec71cc86aa4
NASUX_PKG_DEPENDS="libc++, qt6-qtbase (>= ${NASUX_PKG_VERSION})"
TERMUX_PKG_BUILD_DEPENDS="qt6-qtlanguageserver (>= ${NASUX_PKG_VERSION}), qt6-shadertools (>= ${NASUX_PKG_VERSION})"
...
termux_step_pre_configure() {
	...
	# https://github.com/nastech-ai/NasUX-Packages/issues/21733:
	LDFLAGS+=" -flto"
}
