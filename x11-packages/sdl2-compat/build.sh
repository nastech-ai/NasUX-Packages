...
NASUX_PKG_DESCRIPTION="Simple DirectMedia Layer (SDL) sdl2-compat"
NASUX_PKG_LICENSE="ZLIB"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="2.32.70"
NASUX_PKG_SRCURL="https://github.com/libsdl-org/sdl2-compat/releases/download/release-${NASUX_PKG_VERSION}/sdl2-compat-${NASUX_PKG_VERSION}.tar.gz"
NASUX_PKG_SHA256=998fa62557eb46ffe7e5c3e2c123bc332f7df9d9f593b3ceed88ed1158428a44
NASUX_PKG_DEPENDS="sdl3"
