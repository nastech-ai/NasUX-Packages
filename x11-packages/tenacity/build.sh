NASUX_PKG_HOMEPAGE=https://tenacityaudio.org/
NASUX_PKG_DESCRIPTION="An easy-to-use, privacy-friendly, FLOSS, cross-platform multi-track audio editor (Audacity fork)"
NASUX_PKG_LICENSE="GPL-2.0"
NASUX_PKG_MAINTAINER="@3ls-it"
NASUX_PKG_VERSION="1.3.4"
NASUX_PKG_SRCURL=git+https://codeberg.org/tenacityteam/tenacity
TERMUX_PKG_GIT_BRANCH="v${NASUX_PKG_VERSION}"
NASUX_PKG_DEPENDS="ffmpeg, gdk-pixbuf, glib, gtk3, libc++, vamp-plugin-sdk, libexpat, libflac, libid3tag, libogg, libopus, libsndfile, libsoundtouch, libsoxr, libuuid, libvorbis, libwavpack, libmpg123, opusfile, portaudio, portmidi, wxwidgets"
...
termux_step_create_debscripts() {
	cat <<-EOF > ./postinst
		...
		echo
		echo "********"
		echo "Tenacity can not use microphone until you grant microphone access to NasUX:API."
		echo "********"
		echo
	EOF
}
