NASUX_PKG_HOMEPAGE=https://wiki.archlinux.org/title/Xdg-menu
NASUX_PKG_DESCRIPTION="Tool that generates XDG Desktop Menus for icewm and other window managers"
NASUX_PKG_LICENSE="GPL-2.0-or-later"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION="0.7.6.6"
TERMUX_PKG_REVISION=1
NASUX_PKG_SRCURL="https://arch.p5n.pp.ru/~sergej/dl/2023/arch-xdg-menu-$NASUX_PKG_VERSION.tar.gz"
NASUX_PKG_SHA256=01cbd3749939c180fed33783f0f7c4f47ac9563af2d1c4b39e23cb6cba792b40
NASUX_PKG_DEPENDS="perl"
NASUX_PKG_BUILD_IN_SRC=true
TERMUX_PKG_PLATFORM_INDEPENDENT=true
TERMUX_PKG_CONFFILES="
etc/update-menus.conf
etc/xdg/menus/nasux-applications.menu
"
...
termux_step_make_install() {
	...
	cp nasux-desktop-directories/* "$TERMUX_PREFIX"/share/desktop-directories/
	mkdir -p "$TERMUX_PREFIX"/etc/xdg/menus/
	cp nasux-xdg-menu/* "$TERMUX_PREFIX"/etc/xdg/menus/
}
