...
NASUX_PKG_DESCRIPTION="X.org 100dpi fonts"
NASUX_PKG_LICENSE="custom"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION=1.0.4
_FONT_ADOBE_UTOPIA_VERSION=${NASUX_PKG_VERSION%.*}.$((${NASUX_PKG_VERSION##*.}+1))
NASUX_PKG_SRCURL=(https://xorg.freedesktop.org/releases/individual/font/font-adobe-100dpi-${NASUX_PKG_VERSION}.tar.xz
                   https://xorg.freedesktop.org/releases/individual/font/font-adobe-utopia-100dpi-${_FONT_ADOBE_UTOPIA_VERSION}.tar.xz
                   https://xorg.freedesktop.org/releases/individual/font/font-bh-100dpi-${NASUX_PKG_VERSION}.tar.xz
                   https://xorg.freedesktop.org/releases/individual/font/font-bh-lucidatypewriter-100dpi-${NASUX_PKG_VERSION}.tar.xz
                   https://xorg.freedesktop.org/releases/individual/font/font-bitstream-100dpi-${NASUX_PKG_VERSION}.tar.xz)
NASUX_PKG_SHA256=(b67aff445e056328d53f9732d39884f55dd8d303fc25af3dbba33a8ba35a9ccf
