...
NASUX_PKG_DESCRIPTION="X.org 75dpi fonts"
NASUX_PKG_LICENSE="custom"
NASUX_PKG_MAINTAINER="@nastech-ai"
NASUX_PKG_VERSION=1.0.4
_FONT_ADOBE_UTOPIA_VERSION=${NASUX_PKG_VERSION%.*}.$((${NASUX_PKG_VERSION##*.}+1))
NASUX_PKG_SRCURL=(https://xorg.freedesktop.org/releases/individual/font/font-adobe-75dpi-${NASUX_PKG_VERSION}.tar.xz
                   https://xorg.freedesktop.org/releases/individual/font/font-adobe-utopia-75dpi-${_FONT_ADOBE_UTOPIA_VERSION}.tar.xz
                   https://xorg.freedesktop.org/releases/individual/font/font-bh-75dpi-${NASUX_PKG_VERSION}.tar.xz
                   https://xorg.freedesktop.org/releases/individual/font/font-bh-lucidatypewriter-75dpi-${NASUX_PKG_VERSION}.tar.xz
                   https://xorg.freedesktop.org/releases/individual/font/font-bitstream-75dpi-${NASUX_PKG_VERSION}.tar.xz)
NASUX_PKG_SHA256=(1281a62dbeded169e495cae1a5b487e1f336f2b4d971d92911c59c103999b911
